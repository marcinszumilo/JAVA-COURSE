...
import org.junit.jupiter.api.*;                                         // [4]
...
class WeatherForecastTestSuite {                                                 // [10]
    ...
    void testCalculateAverageWithMock() {                                        // [12]
        ...
        //When
        double averageTemperautre = weatherForecast.calculateAverage();        // [22]

        //Then
        Assertions.assertEquals(25.56, averageTemperautre);
    }                                                                             // [24]
    ...
    void testCalculateMedianWithMock() {                                        // [12]
        ...
        //When
        double medianTemperautre = weatherForecast.calculateMedian();        // [22]

        //Then
        Assertions.assertEquals(25.35, medianTemperautre);
    }                                                                             // [24
}